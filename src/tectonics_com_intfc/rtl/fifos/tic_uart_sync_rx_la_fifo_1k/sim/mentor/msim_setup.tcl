...
alias com {
  ...
  set common_design_files [dict values [tic_uart_sync_rx_la_fifo_1k::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [tic_uart_sync_rx_la_fifo_1k::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
