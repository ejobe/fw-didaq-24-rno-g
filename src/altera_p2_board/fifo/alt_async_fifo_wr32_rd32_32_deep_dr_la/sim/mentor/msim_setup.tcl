...
alias com {
  ...
  set common_design_files [dict values [alt_async_fifo_wr32_rd32_32_deep_dr_la::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [alt_async_fifo_wr32_rd32_32_deep_dr_la::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
