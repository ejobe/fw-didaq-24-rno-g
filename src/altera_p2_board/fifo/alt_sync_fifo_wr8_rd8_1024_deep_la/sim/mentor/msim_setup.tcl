...
alias com {
  ...
  set common_design_files [dict values [alt_sync_fifo_wr8_rd8_1024_deep_la::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [alt_sync_fifo_wr8_rd8_1024_deep_la::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
