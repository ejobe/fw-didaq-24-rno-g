...
alias com {
  ...
  set common_design_files [dict values [alt_async_fifo_wr64_rd64_256_deep_la::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [alt_async_fifo_wr64_rd64_256_deep_la::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
