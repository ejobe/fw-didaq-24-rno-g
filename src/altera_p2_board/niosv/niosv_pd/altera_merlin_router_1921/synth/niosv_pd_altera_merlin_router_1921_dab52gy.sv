...
//    output_name             niosv_pd_altera_merlin_router_1921_dab52gy
//    pkt_addr_h              67
//    pkt_addr_l              36
//    pkt_dest_id_h           94
//    pkt_dest_id_l           91
...
//    pkt_trans_read          71
//    pkt_trans_write         70
//    slaves_info             7:100000000:0x40000:0x60000:both:1:0:0:1,3:010000000:0x80000:0xa0000:both:1:0:0:1,8:001000000:0x1000000:0x1000020:both:1:0:0:1,1:000010000:0x1010000:0x1010400:both:1:0:0:1,2:000001000:0x1020000:0x1020400:both:1:0:0:1,0:000000100:0x1080000:0x10a0000:both:1:0:0:1,4:000000010:0x10a0000:0x10a1000:both:1:0:0:1,5:000000001:0x10b0000:0x10b1000:both:1:0:0:1,6:000100000:0x10d0000:0x10d0020:both:1:0:0:1
//    st_channel_w            9
//    st_data_w               162
// ------------------------------------------

module niosv_pd_altera_merlin_router_1921_dab52gy_default_decode
  #(
...
module niosv_pd_altera_merlin_router_1921_dab52gy
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    niosv_pd_altera_merlin_router_1921_dab52gy_default_decode the_default_decode(
    ...
    always @* begin
        ...
        // slave 8: [0x10d0000, 0x10d0020) : sel [24:5]
