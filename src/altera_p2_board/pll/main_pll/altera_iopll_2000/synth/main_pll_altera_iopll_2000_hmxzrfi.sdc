...
#    * The helper routines are defined in main_pll_altera_iopll_2000_hmxzrfi_pin_map.tcl
#
# NOTE
# ----
...
source "$script_dir/main_pll_altera_iopll_2000_hmxzrfi_parameters.tcl"
source "$script_dir/main_pll_altera_iopll_2000_hmxzrfi_pin_map.tcl"
source "$script_dir/main_pll_altera_iopll_2000_hmxzrfi_all_ip_params.tcl"
...
if {[info exists ::GLOBAL_top_main_pll_altera_iopll_2000_hmxzrfi_corename_ai_pll_db]} {
    # Clean-up stale content
    unset ::GLOBAL_top_main_pll_altera_iopll_2000_hmxzrfi_corename_ai_pll_db
}
if {[catch {ai_initialize_pll_db ::GLOBAL_top_main_pll_altera_iopll_2000_hmxzrfi_corename_ai_pll_db} err_initializing_db]} {
...
# following loop
set instances [ array names ::GLOBAL_top_main_pll_altera_iopll_2000_hmxzrfi_corename_ai_pll_db ]
foreach { inst } $instances {
    ...
    lassign $::GLOBAL_top_main_pll_altera_iopll_2000_hmxzrfi_corename_ai_pll_db($inst) base_clock_data_dict gen_clock_data_dict
