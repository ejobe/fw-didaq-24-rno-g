...
alias com {
  ...
  set common_design_files [dict values [jesd204b_core::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [jesd204b_core::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
