...
module shared_hal_coreip 
  #(
    ...
    parameter ch0_lc_postdiv_sel_sm4_atom                   = "CH0_LC_POSTDIV_SEL_SYNTH_FAST"                      ,   
    parameter ch0_lc_postdiv_sel_sm7_atom                   = "CH0_LC_POSTDIV_SEL_SYNTH_FAST"                      ,   
    ...
    parameter ch0_xcvr_tx_protocol_hint_atom                = "CH0_TX_PROTOCOL_HINT_DISABLED"                      , 
    ...
    parameter ch1_lc_postdiv_sel_sm4_atom                   = "CH1_LC_POSTDIV_SEL_SYNTH_FAST"                      ,   
    parameter ch1_lc_postdiv_sel_sm7_atom                   = "CH1_LC_POSTDIV_SEL_SYNTH_FAST"                      ,    
    ...
    parameter ch1_xcvr_tx_protocol_hint_atom                = "CH1_TX_PROTOCOL_HINT_DISABLED"                      , 
    ...
    parameter ch2_lc_postdiv_sel_sm4_atom                   = "CH2_LC_POSTDIV_SEL_SYNTH_FAST"                      ,   
    parameter ch2_lc_postdiv_sel_sm7_atom                   = "CH2_LC_POSTDIV_SEL_SYNTH_FAST"                      ,    
    ...
    parameter ch2_xcvr_tx_protocol_hint_atom                = "CH2_TX_PROTOCOL_HINT_DISABLED"                      , 
    ...
    parameter ch3_lc_postdiv_sel_sm4_atom                   = "CH3_LC_POSTDIV_SEL_SYNTH_FAST"                      ,   
    parameter ch3_lc_postdiv_sel_sm7_atom                   = "CH3_LC_POSTDIV_SEL_SYNTH_FAST"                      ,    
    ...
    parameter ch3_xcvr_tx_protocol_hint_atom                = "CH3_TX_PROTOCOL_HINT_DISABLED"                      , 
    ...
    parameter ch0_rx_invert_pin_atom                        = "CH0_RX_INVERT_PIN_DISABLE"                          ,
    parameter ch1_rx_invert_pin_atom                        = "CH1_RX_INVERT_PIN_DISABLE"                          ,
    parameter ch2_rx_invert_pin_atom                        = "CH2_RX_INVERT_PIN_DISABLE"                          ,
    parameter ch3_rx_invert_pin_atom                        = "CH3_RX_INVERT_PIN_DISABLE"                          ,
    parameter ch0_tx_invert_pin_atom                        = "CH0_TX_INVERT_PIN_DISABLE"                          ,
    parameter ch1_tx_invert_pin_atom                        = "CH1_TX_INVERT_PIN_DISABLE"                          ,
    parameter ch2_tx_invert_pin_atom                        = "CH2_TX_INVERT_PIN_DISABLE"                          ,
    parameter ch3_tx_invert_pin_atom                        = "CH3_TX_INVERT_PIN_DISABLE"                          ,
    parameter ch0_vsr_mode_atom                             = "CH0_VSR_MODE_DISABLED"                              ,
    parameter ch1_vsr_mode_atom                             = "CH1_VSR_MODE_DISABLED"                              ,
    parameter ch2_vsr_mode_atom                             = "CH2_VSR_MODE_DISABLED"                              ,
    parameter ch3_vsr_mode_atom                             = "CH3_VSR_MODE_DISABLED"                              ,
    ...
    parameter ch0_xcvr_rx_force_cdr_ltr_atom                       = "FALSE"  ,
    parameter ch1_xcvr_rx_force_cdr_ltr_atom                       = "FALSE"  ,
    parameter ch2_xcvr_rx_force_cdr_ltr_atom                       = "FALSE"  ,
    parameter ch3_xcvr_rx_force_cdr_ltr_atom                       = "FALSE"  ,
...
localparam ch0_sim_mode_atom_l = ch0_sim_mode_atom;
localparam ch1_sim_mode_atom_l = ch1_sim_mode_atom;
localparam ch2_sim_mode_atom_l = ch2_sim_mode_atom;
localparam ch3_sim_mode_atom_l = ch3_sim_mode_atom;
`else
// See https://wiki.ith.intel.com/pages/viewpage.action?pageId=3466839469#ParameterOverloading
localparam ch0_sim_mode_atom_l = {ch0_sim_mode_atom, ":", (tx_channel_mode_atom == "ETH_MODE" || rx_channel_mode_atom == "ETH_MODE") ? "ETH_MODE" : "NONE"};
localparam ch1_sim_mode_atom_l = {ch1_sim_mode_atom, ":", (tx_channel_mode_atom == "ETH_MODE" || rx_channel_mode_atom == "ETH_MODE") ? "ETH_MODE" : "NONE"};
localparam ch2_sim_mode_atom_l = {ch2_sim_mode_atom, ":", (tx_channel_mode_atom == "ETH_MODE" || rx_channel_mode_atom == "ETH_MODE") ? "ETH_MODE" : "NONE"};
localparam ch3_sim_mode_atom_l = {ch3_sim_mode_atom, ":", (tx_channel_mode_atom == "ETH_MODE" || rx_channel_mode_atom == "ETH_MODE") ? "ETH_MODE" : "NONE"};
`endif
...
mc #(
    ...
    .x_std_sm_hssi_fec_wrap_0__ch0_sim_mode                                        (ch0_sim_mode_atom_l                         ),
    ...
    .x_std_sm_hssi_fec_wrap_0__ch1_sim_mode                                        (ch1_sim_mode_atom_l                         ),
    ...
    .x_std_sm_hssi_fec_wrap_0__ch2_sim_mode                                        (ch2_sim_mode_atom_l                         ),
    ...
    .x_std_sm_hssi_fec_wrap_0__ch3_sim_mode                                        (ch3_sim_mode_atom_l                         ),
    ...
    .x_std_ipfluxtop_flux_core_shim_wrap_0__ch0_rx_force_cdr_ltr                   (ch0_xcvr_rx_force_cdr_ltr_atom              ),
    .x_std_ipfluxtop_flux_core_shim_wrap_0__ch1_rx_force_cdr_ltr                   (ch1_xcvr_rx_force_cdr_ltr_atom              ),
    .x_std_ipfluxtop_flux_core_shim_wrap_0__ch2_rx_force_cdr_ltr                   (ch2_xcvr_rx_force_cdr_ltr_atom              ),
    .x_std_ipfluxtop_flux_core_shim_wrap_0__ch3_rx_force_cdr_ltr                   (ch3_xcvr_rx_force_cdr_ltr_atom              ),
    .x_std_ipfluxtop_flux_core_shim_wrap_0__ch0_rx_protocol_hint                   (ch0_xcvr_rx_protocol_hint_atom              ),
    .x_std_ipfluxtop_flux_core_shim_wrap_0__ch1_rx_protocol_hint                   (ch1_xcvr_rx_protocol_hint_atom              ),
    .x_std_ipfluxtop_flux_core_shim_wrap_0__ch2_rx_protocol_hint                   (ch2_xcvr_rx_protocol_hint_atom              ),
    .x_std_ipfluxtop_flux_core_shim_wrap_0__ch3_rx_protocol_hint                   (ch3_xcvr_rx_protocol_hint_atom              ),
    .x_std_ipfluxtop_flux_core_shim_wrap_0__ch0_tx_protocol_hint                   (ch0_xcvr_tx_protocol_hint_atom              ),
    .x_std_ipfluxtop_flux_core_shim_wrap_0__ch1_tx_protocol_hint                   (ch1_xcvr_tx_protocol_hint_atom              ),
    .x_std_ipfluxtop_flux_core_shim_wrap_0__ch2_tx_protocol_hint                   (ch2_xcvr_tx_protocol_hint_atom              ),
    .x_std_ipfluxtop_flux_core_shim_wrap_0__ch3_tx_protocol_hint                   (ch3_xcvr_tx_protocol_hint_atom              ),
    ...
    .x_std_sm_ux_toolbox_0__ch0_lc_postdiv_sel                                     ((device_die_revisions == "MAIN_SM7_REVA")? ch0_lc_postdiv_sel_sm7_atom : ch0_lc_postdiv_sel_sm4_atom),
    ...
    .x_std_sm_ux_toolbox_0__ch1_lc_postdiv_sel                                     ((device_die_revisions == "MAIN_SM7_REVA")? ch1_lc_postdiv_sel_sm7_atom : ch1_lc_postdiv_sel_sm4_atom),
    ...
    .x_std_sm_ux_toolbox_0__ch2_lc_postdiv_sel                                     ((device_die_revisions == "MAIN_SM7_REVA")? ch2_lc_postdiv_sel_sm7_atom : ch2_lc_postdiv_sel_sm4_atom),
    ...
    .x_std_sm_ux_toolbox_0__ch3_lc_postdiv_sel                                     ((device_die_revisions == "MAIN_SM7_REVA")? ch3_lc_postdiv_sel_sm7_atom : ch3_lc_postdiv_sel_sm4_atom),
    ...
    .x_std_sm_ux_toolbox_0__ch0_rx_invert_pin_atom                                 (ch0_rx_invert_pin_atom       ),
    .x_std_sm_ux_toolbox_0__ch1_rx_invert_pin_atom                                 (ch1_rx_invert_pin_atom       ),
    .x_std_sm_ux_toolbox_0__ch2_rx_invert_pin_atom                                 (ch2_rx_invert_pin_atom       ),
    .x_std_sm_ux_toolbox_0__ch3_rx_invert_pin_atom                                 (ch3_rx_invert_pin_atom       ),
    .x_std_sm_ux_toolbox_0__ch0_tx_invert_pin_atom                                 (ch0_tx_invert_pin_atom       ),
    .x_std_sm_ux_toolbox_0__ch1_tx_invert_pin_atom                                 (ch1_tx_invert_pin_atom       ),
    .x_std_sm_ux_toolbox_0__ch2_tx_invert_pin_atom                                 (ch2_tx_invert_pin_atom       ),
    .x_std_sm_ux_toolbox_0__ch3_tx_invert_pin_atom                                 (ch3_tx_invert_pin_atom       ),
    .x_std_sm_ux_toolbox_0__ch0_vsr_mode_atom                                      (ch0_vsr_mode_atom            ),
    .x_std_sm_ux_toolbox_0__ch1_vsr_mode_atom                                      (ch1_vsr_mode_atom            ),
    .x_std_sm_ux_toolbox_0__ch2_vsr_mode_atom                                      (ch2_vsr_mode_atom            ),
    .x_std_sm_ux_toolbox_0__ch3_vsr_mode_atom                                      (ch3_vsr_mode_atom            )
) mc_inst (
...
`pragma questa_oem_00 ""
`endif