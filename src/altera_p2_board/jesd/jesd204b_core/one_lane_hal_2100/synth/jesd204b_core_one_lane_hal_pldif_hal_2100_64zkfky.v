// jesd204b_core_one_lane_hal_pldif_hal_2100_64zkfky.v

// Generated using ACDS version 25.1.1 125

`timescale 1 ps / 1 ps
module jesd204b_core_one_lane_hal_pldif_hal_2100_64zkfky #(
		...
		parameter[35:0] ch_pldif_rx_fifo_wr_clk_hz_atom          = 36'b000000001110111001101011001010000000,
		parameter[35:0] ch_pldif_tx_fifo_rd_clk_hz_atom          = 36'b000000001110111001101011001010000000,
	...
	generate
		...
		if (ch_pldif_rx_fifo_wr_clk_hz_atom != 36'b000000001110111001101011001010000000)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_pldif_tx_fifo_rd_clk_hz_atom != 36'b000000001110111001101011001010000000)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
	...
	jesd204b_core_pldif_hal_2100_its2isq #(
		...
		.ch_pldif_rx_fifo_wr_clk_hz_atom          (36'b000000001110111001101011001010000000),
		.ch_pldif_tx_fifo_rd_clk_hz_atom          (36'b000000001110111001101011001010000000),
