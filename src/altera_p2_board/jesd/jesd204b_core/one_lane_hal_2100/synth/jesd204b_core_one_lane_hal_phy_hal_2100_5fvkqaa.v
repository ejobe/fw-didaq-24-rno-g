// jesd204b_core_one_lane_hal_phy_hal_2100_5fvkqaa.v

// Generated using ACDS version 25.1.1 125

`timescale 1 ps / 1 ps
module jesd204b_core_one_lane_hal_phy_hal_2100_5fvkqaa #(
		...
		parameter[35:0] ch_l_xcvr_cdr_f_out_hz_atom                        = 36'b000010010101000000101111100100000000,
		...
		parameter[5:0]  ch_l_cdr_l_counter_atom                            = 6'b000100,
		...
		parameter[36:0] ch_l_xcvr_tx_datarate_bps_atom                     = 37'b0000100101010000001011111001000000000,
		...
		parameter[36:0] ch_l_xcvr_rx_datarate_bps_atom                     = 37'b0000100101010000001011111001000000000,
		...
		parameter[35:0] ch_l_xcvr_rx_word_clk_hz_atom                      = 36'b000000001110111001101011001010000000,
		...
		parameter       ch_l_xcvr_rx_termination_mode_atom                 = "RX_TERMINATION_MODE_DIFFERENTIAL",
		...
		parameter[35:0] ch_eth_rx_clk_hz_atom                              = 36'b000000001110111001101011001010000000,
		parameter[35:0] ch_eth_tx_clk_hz_atom                              = 36'b000000001110111001101011001010000000
	) (
	...
	generate
		...
		if (ch_l_xcvr_cdr_f_out_hz_atom != 36'b000010010101000000101111100100000000)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_l_cdr_l_counter_atom != 6'b000100)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_l_xcvr_tx_datarate_bps_atom != 37'b0000100101010000001011111001000000000)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_l_xcvr_rx_datarate_bps_atom != 37'b0000100101010000001011111001000000000)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_l_xcvr_rx_word_clk_hz_atom != 36'b000000001110111001101011001010000000)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_l_xcvr_rx_termination_mode_atom != "RX_TERMINATION_MODE_DIFFERENTIAL")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_eth_rx_clk_hz_atom != 36'b000000001110111001101011001010000000)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_eth_tx_clk_hz_atom != 36'b000000001110111001101011001010000000)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
	...
	jesd204b_core_phy_hal_2100_qknnvui #(
		...
		.ch_l_xcvr_cdr_f_out_hz_atom                        (36'b000010010101000000101111100100000000),
		...
		.ch_l_cdr_l_counter_atom                            (6'b000100),
		...
		.ch_l_xcvr_tx_datarate_bps_atom                     (37'b0000100101010000001011111001000000000),
		...
		.ch_l_xcvr_rx_datarate_bps_atom                     (37'b0000100101010000001011111001000000000),
		...
		.ch_l_xcvr_rx_word_clk_hz_atom                      (36'b000000001110111001101011001010000000),
		...
		.ch_l_xcvr_rx_termination_mode_atom                 ("RX_TERMINATION_MODE_DIFFERENTIAL"),
		...
		.ch_eth_rx_clk_hz_atom                              (36'b000000001110111001101011001010000000),
		.ch_eth_tx_clk_hz_atom                              (36'b000000001110111001101011001010000000)
	) phy_hal_top (
