// jesd204b_core_one_lane_hal_phy_hal_2100_ol7u6fi.v

// Generated using ACDS version 25.1.1 125

`timescale 1 ps / 1 ps
module jesd204b_core_one_lane_hal_phy_hal_2100_ol7u6fi #(
		...
		parameter[35:0] ch_l_xcvr_cdr_f_pfd_hz_atom                        = 36'b000000001001010100000010111110010000,
		...
		parameter[8:0]  ch_l_cdr_m_counter_atom                            = 9'b000100000,
	...
	generate
		...
		if (ch_l_xcvr_cdr_f_pfd_hz_atom != 36'b000000001001010100000010111110010000)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_l_cdr_m_counter_atom != 9'b000100000)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
	...
	jesd204b_core_phy_hal_2100_onox6si #(
		...
		.ch_l_xcvr_cdr_f_pfd_hz_atom                        (36'b000000001001010100000010111110010000),
		.ch_l_xcvr_cdr_f_ref_hz_atom                        (36'b000000001001010100000010111110010000),
		.ch_l_cdr_l_counter_atom                            (6'b000010),
		.ch_l_cdr_m_counter_atom                            (9'b000100000),
