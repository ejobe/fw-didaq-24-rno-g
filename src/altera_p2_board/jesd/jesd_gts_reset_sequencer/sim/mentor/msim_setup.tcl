...
alias com {
  ...
  set common_design_files [dict values [jesd_gts_reset_sequencer::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [jesd_gts_reset_sequencer::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
